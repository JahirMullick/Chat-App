...
const PlusIcon = ({ size = 24, width, height, ...props }: PlusIconProps) => (
    <Svg
        width={width || size}
        height={height || size}
        viewBox="0 0 512 512"
    ...
    >
        <G>
            <Path
                opacity={0.998}
                fill="#2196f3"
                d="M 232.5,-0.5 C 247.833,-0.5 263.167,-0.5 278.5,-0.5C 378.271,12.4486 449.438,64.4486 492,155.5C 502.136,180.379 508.636,206.046 511.5,232.5C 511.5,247.833 511.5,263.167 511.5,278.5C 498.551,378.271 446.551,449.438 355.5,492C 330.622,502.136 304.955,508.636 278.5,511.5C 263.167,511.5 247.833,511.5 232.5,511.5C 132.727,498.549 61.5605,446.549 19,355.5C 8.86392,330.621 2.36392,304.954 -0.5,278.5C -0.5,263.167 -0.5,247.833 -0.5,232.5C 12.4486,132.729 64.4486,61.5622 155.5,19C 180.379,8.86392 206.046,2.36392 232.5,-0.5 Z"
            />
        </G>
        <G>
            <Path
